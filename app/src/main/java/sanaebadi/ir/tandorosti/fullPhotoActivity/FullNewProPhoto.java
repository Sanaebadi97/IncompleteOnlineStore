...
public class FullNewProPhoto extends AppCompatActivity {

  private static final String TAG = "FullNewProPhoto";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_full_new_pro_photo);
