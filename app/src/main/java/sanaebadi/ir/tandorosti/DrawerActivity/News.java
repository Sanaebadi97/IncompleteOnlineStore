...
import sanaebadi.ir.tandorosti.NewsFragment.FruitFragment;
import sanaebadi.ir.tandorosti.R;
import sanaebadi.ir.tandorosti.adapter.TabLayViewPagerAdapter;
import sanaebadi.ir.tandorosti.app.BaseActivity;
import sanaebadi.ir.tandorosti.NewsFragment.ProteinFragment;
import sanaebadi.ir.tandorosti.NewsFragment.SiffyFragment;
import sanaebadi.ir.tandorosti.NewsFragment.VegetablesFragment;
...
public class News extends BaseActivity {
  ...
  private void setupViewpager(ViewPager viewPager) {
    ...
    adapter.addFragment(new SiffyFragment(), "صیفی جات");
    adapter.addFragment(new ProteinFragment(), "پروتئین");
    adapter.addFragment(new FruitFragment(), "میوه");
    adapter.addFragment(new VegetablesFragment(), "سبزیجات");
    adapter.addFragment(new DairyFragment(), "لبنیات");
