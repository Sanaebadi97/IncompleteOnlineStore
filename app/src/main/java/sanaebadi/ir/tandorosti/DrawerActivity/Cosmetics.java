...
import sanaebadi.ir.tandorosti.CosmeticsFragments.CosmeticsFragment;
import sanaebadi.ir.tandorosti.CosmeticsFragments.MedicinalPlantsFragment;
import sanaebadi.ir.tandorosti.CosmeticsFragments.SanitaryFragment;
...
public class Cosmetics extends BaseActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.layout_cosmetics);
  ...
  private void setupViewpager(ViewPager viewPager) {
    ...
    adapter.addFragment(new MedicinalPlantsFragment(), "گیاهان دارویی");
    adapter.addFragment(new SanitaryFragment(), "بهداشتی");
    adapter.addFragment(new CosmeticsFragment(), "آرایشی");
