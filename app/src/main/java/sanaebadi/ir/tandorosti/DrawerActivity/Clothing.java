...
import sanaebadi.ir.tandorosti.ClothesFragment.FeltProductsFragment;
import sanaebadi.ir.tandorosti.ClothesFragment.KidsFragment;
import sanaebadi.ir.tandorosti.ClothesFragment.MensFragment;
import sanaebadi.ir.tandorosti.ClothesFragment.WomensFragment;
...
public class Clothing extends BaseActivity {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setContentView(R.layout.layout_clothing);
  ...
  private void setupViewpager(ViewPager viewPager) {
    ...
    adapter.addFragment(new FeltProductsFragment(), "محصولات نمدی");
    adapter.addFragment(new KidsFragment(), "کودک");
    adapter.addFragment(new WomensFragment(), "زنانه");
    adapter.addFragment(new MensFragment(), "مردانه");
