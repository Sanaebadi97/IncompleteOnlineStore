...
import sanaebadi.ir.tandorosti.NewsDetailsActivity.FruitDetailsActivity;
...
public class FruitAdapter extends RecyclerView.Adapter<FruitAdapter.FruitViewHolder> {
  ...
  public FruitViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(context).inflate(R.layout.fruit_frag_pro_single, parent, false);
  ...
  public void onBindViewHolder(@NonNull FruitViewHolder holder, int position) {
    ...
    holder.txt_name_pro.setText(fruit.getPro_name());
    holder.txt_price.setText(String.valueOf(fruit.getPro_price()));
    holder.txt_weight.setText(String.valueOf(fruit.getPro_weight()));
    ...
    holder.first_card.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        intent.putExtra("PRO_IMAGE", fruit.getPro_image());
        intent.putExtra("PRO_NAME", fruit.getPro_name());
        intent.putExtra("PRO_PRICE", fruit.getPro_price());
        intent.putExtra("PRO_DESC", fruit.getPro_desc());
    ...
    holder.txt_price.setText(" " + formatter.format(fruit.getPro_price()));
