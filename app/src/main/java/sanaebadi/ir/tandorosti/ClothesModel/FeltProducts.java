package sanaebadi.ir.tandorosti.ClothesModel;
...
public class FeltProducts {
  ...
  public FeltProducts(int id, String pro_image, String pro_name, int pro_price, int pro_weight, String pro_desc) {
    this.id = id;
